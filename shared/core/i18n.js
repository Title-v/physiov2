...
export const STRINGS = {
  en: {
    ...
    mobileApp: 'Patient app', webDashboard: 'Web dashboard',
    navHint: 'Use the top-right menu to jump between any screen',

    // Roles / nav
    home: 'Home', back: 'Back', screens: 'Screens',
    patientMobile: 'Patient (web)', therapistWeb: 'Therapist (web)',
  ...
  th: {
    ...
    mobileApp: 'เว็บผู้ป่วย', webDashboard: 'แดชบอร์ดบนเว็บ',
    navHint: 'เปิดเมนูมุมบนขวาเพื่อไปยังหน้าจออื่น',

    home: 'หน้าแรก', back: 'ย้อนกลับ', screens: 'เลือกหน้าจอ',
    patientMobile: 'ผู้ป่วย (เว็บ)', therapistWeb: 'นักกายภาพ (เว็บ)',
